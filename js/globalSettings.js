app.service('gsets', ['$http', '$rootScope', function ($http, $rootScope) {
    ...
    this.mode = 'single'; //Set this to 'multi' if your site is based on more than one youtube playlist. For websites based on a single playlist set this attribute as 'single'.
